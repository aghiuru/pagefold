...
**Disclaimer:** The following blog post discusses investigational medicines not yet approved by the FDA or other regulatory bodies. Data presented is for educational purposes only, does not constitute medical or investment advice, and involves significant risks. Clinical trial results are preliminary and do not guarantee future success. The safety and efficacy of these compounds have not been established; there is no guarantee that these investigational agents will receive regulatory approval or become commercially available for the uses discussed. Please find our full disclaimer at the bottom of the post and in our “About” page here.

![](images/7e85aa73514a.png)

### Introduction

On March 31, 20261, Eli Lilly and Company announced that it has entered into a definitive agreement to acquire Centessa Pharmaceuticals for an upfront cash payment of approximately $6.3 billion plus potential contingent payments of approximately $1.5 billion. The upfront payment represents a premium of approximately 40.5% to Centessa’s 30-day volume-weighted average trading price ending March 30, 2026.
...
Drs. Luis de Lecea and Greg Sutcliffe at the Scripps Research Institute were looking for genes expressed only in the hypothalamus. They found two peptides and named them Hypocretins (a mix of hypothalamus and incretin, a type of hormone)2.**The “Hypocretin” Team:**Dr. Masashi Yanagisawa at the University of Texas was searching for molecules that regulate appetite. He found the same peptides and named them Orexins (from the Greek**The “Orexin” Team:***orexis*, meaning appetite)3.
...
Dr. Emmanuel Mignot had spent a decade breeding a colony of narcoleptic Dobermans. In 1999, his team discovered that these dogs had a mutation in the Hypocretin Receptor 2 gene4. Without a working receptor, their brains couldn’t “hear” the signal to stay awake.**The Stanford Dogs:**Simultaneously, Yanagisawa’s team created “knockout” mice that couldn’t produce orexin at all. These mice showed classic signs of narcolepsy, including cataplexy (sudden muscle collapse), which was caught on video for the first time in rodents.**The Knockout Mice:**
...
If the cells are missing but there’s no genetic mutation, what killed them? This led to the modern consensus that narcolepsy is an autoimmune disease. Scientists noticed that 98% of people with Narcolepsy Type 1 carry a specific immune system gene marker called HLA-DQB1*06:025. A major clue surfaced after the 2009 H1N1 flu pandemic. In China and parts of Europe (related to the *Pandemrix *vaccine), there was a sudden spike in narcolepsy cases. Researchers believe that a protein in the flu virus looks so similar to the hypocretin receptor that the body’s immune system gets “confused.” It trains its T-cells to attack the virus, but those same T-cells then cross the blood-brain barrier and destroy the hypocretin neurons by mistake6.
...
### Counting Sheep, and Orexin Receptors
...
Researchers found that Orexin-A binds to both receptors with equal high affinity. However, Orexin-B is highly selective for OX2R (it is 10x more potent at OX2 than OX1). This chemical difference allowed scientists to use Orexin-B to isolate OX2R activity.**Ligand Binding (The “Key”):**By breeding mice that lacked specific genes, they isolated the “symptoms”:**Genetic “Knockouts”:**Showed almost no sleep-wake abnormalities.**OX1R Knockouts:**Showed significant sleepiness and fragmented wakefulness, but rarely “collapsed” (cataplexy).**OX2R Knockouts:**Showed the full-blown narcolepsy phenotype, including severe cataplexy.**Double Knockouts (OX1 + OX2):**

Researchers used mRNA staining to see where the receptors lived.**Anatomical Mapping:**OX1R is heavily concentrated in the Locus Coeruleus (LC) (responsible for noradrenaline and muscle tone).

OX2R is dominant in the Tuberomammillary Nucleus (TMN) (responsible for histamine and the “master switch” for wakefulness).
...
### Burning the Midnight Oil, on Drug Development
...
*To contact us, please send us an email at pipeline.review@gmail.com*

## Disclaimers

#### “Investigational Status” Disclaimer

The treatments discussed on this blog are currently under investigation and have not been approved by the U.S. Food and Drug Administration (FDA) or any other regulatory agency for safety or efficacy. Their use outside of clinical trials is strictly prohibited except under specific ‘expanded access’ protocols.

#### No Medical Advice Disclaimer

Content provided here is for informational and educational purposes only. It does not constitute medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition.

#### Forward-Looking Statements

Statements regarding the potential success of clinical trials, regulatory approval timelines, or future market availability are ‘forward-looking statements.’ These involve known and unknown risks, and actual results may differ materially from those expressed or implied.

#### No Patient-Provider Relationship

Use of this website and the information contained herein does not create a doctor-patient or consultant-client relationship between you and *Pipeline Review*.

#### Conflict of Interest

This post was written independently and no compensation was received from the sponsors of the trials discussed.